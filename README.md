...
- **OpenAI connectivity:** attach your own OpenAI API key to drive live answers; a fallback message appears until a key is supplied.
...
4. Attach your OpenAI key: click **Attach API** on either page, paste your `sk-...` token, and the composer will indicate *OpenAI connected*. Keys are stored in your browser only.
